...
<html lang = "en">
  <head>
    <meta charset="utf-8" />
    <title>@yield('title') | Cerebro Digital</title>
    ...
    <link rel="stylesheet" href="/foro/minified/themes/default.min.css" type="text/css" media="all" />

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    <script src="/foro/minified/jquery.sceditor.bbcode.min.js"></script>
